          ...
          >
            ...
            >
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
                Sizning CS2 g&apos;alabangiz kafolati!
              </p>
            </div>
            ...
            <div style={{ marginBottom: '24px', fontSize: '0.95rem' }}>
              ...
              <p>
                <strong>Mijoz:</strong> {customerName || '__________________'}
              </p>
              <p>
                <strong>Telefon:</strong> {phone || '__________________'}
              </p>
            </div>
